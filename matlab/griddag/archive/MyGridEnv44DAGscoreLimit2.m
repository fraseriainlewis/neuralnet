classdef MyGridEnv44DAGscoreLimit2 < rl.env.MATLABEnvironment
    ...
    methods  
        ...
        function this = MyGridEnv44DAGscoreLimit2(stateLookup, scoreLookup)
       ...
       function this = set.lookup(this,stateLookup);
        ...
        function InitialObservation = reset(this)
            ...
            if true
                ...
                InitialObservation = [1]; % first state - this indexes cols in a matrix - 
                this.State = InitialObservation; 
                this.cumReward=0;
                this.numsteps=0; 
            end
