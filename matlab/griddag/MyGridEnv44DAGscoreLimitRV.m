classdef MyGridEnv44DAGscoreLimitRV < rl.env.MATLABEnvironment
    ...
    methods  
        ...
        function this = MyGridEnv44DAGscoreLimitRV(stateLookup, scoreLookup)
       ...
       function this = set.lookup(this,stateLookup);
        ...
        function [Observation,Reward,IsDone,LoggedSignals] = step(this,Action)
          ...
          %  else disp('no action')    
            ...
            % flattened COLWISE which is fine as this.lookup was also created flattened COLWISE
            % the transpose is simply as the lookup is by row
        ...
        function InitialObservation = reset(this)
            ...
            if false
                ...
                InitialObservation = [stateLookup]; % first state - this indexes cols in a matrix - 
                this.State = InitialObservation; 
                this.cumReward=0;
                this.numsteps=0; 
            end
